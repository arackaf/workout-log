...
var _sectionTagDao = require('../dataAccess/sectionTagDao');

var _sectionTagDao2 = _interopRequireDefault(_sectionTagDao);
    ...
    _createClass(TagController, [{
        ...
        value: function () {
            var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
                var sectionTagDAO, results;
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                sectionTagDAO = new _sectionTagDao2.default();
                                _context2.next = 3;
                                return sectionTagDAO.load();
